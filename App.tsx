...
function App ({}){
  ...
  return (
    <>
    <StatusBar
        barStyle="dark-content"  // Change to 'light-content' for light mode
        backgroundColor="#FFFFFF" // Change to your desired background color
      />
    
    <ScrollView style={{marginTop:60, flex:1, backgroundColor:'#FFFFFF'}}>
...
App.navigationOptions = ({ navigation }) => {
  return {
    title: 'title',
    header: true, // this will remove the header
  };
};
